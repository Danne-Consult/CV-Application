    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.morework' ,function(){
				$('.com-work').append('<div class="workcont"> <hr /> <div class="row"> <div class="col-lg-6"> <label for="work">Company/Organization</label><br /> <input type="text" name="company[]" /> </div> </div> <div class="row"> <div class="col-lg-6"> <label for="occupation">Position</label><br /> <input type="text" name="occupation[]" /> </div> <div class="col-lg-2"> <label for="workyearcorfrom">From</label><br /> <input type="month" name="workyearfrom[]" /> </div> <div class="col-lg-2"> <label for="workyearto">To</label><br /> <input type="month" name="workyearto[]" /> </div> </div> <div class="row"> <div class="col-lg-10"> <label for="workcomment">Key Responsibilities</label><br /> <textarea rowspan="3" class="editor" name="workcomment[]" ></textarea> </div> <div class="col-lg-2"> <div class="addbtnbx morework"><i class="fa-solid fa-circle-plus" id="addbtn"></i></div> <div class="delbtnbx deletework"><i class="fa-solid fa-circle-minus"></i></div> </div> </div> </div>');
                mce();
			});
