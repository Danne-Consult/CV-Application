        ...
        <div class="signform">
            <div class="logform">
                ...
                <form action="controller/register.php" method="POST" class="contactForm">
                    ...
                    <div class="row">
                        <div class="col-lg-12">
                            <label for="sector">Which sector best describes you?</label>
                            <select name="sector" required>
                                <option>...</option>
                                <option value="Accounting, Banking and Finance">Accounting, Banking and Finance</option>
                                ...
                                <option value="Biological, Chemical & Pharmaceutical Science">Biological, Chemical & Pharmaceutical Science</option>
                                <option value="Biomedical Technologies & Medtech">Biomedical Technologies & Medtech</option>
                                <option value="Charity and Voluntary Work">Charity and Voluntary Work</option>
                                <option value="Construction, Architecture & Property">Construction, Architecture & Property</option>
                                ...
                                <option value="History, Culture & Languages">History, Culture & Languages</option>
